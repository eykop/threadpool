...
const char* StringsConstants::RequestForValidThreadNumberMessage = "Please provide a valid thread number, you have provide a non number input: '";
const char* StringsConstants::RequestForInRangeThreadNumberMessage = "Please provide a valid thread number, you have provide a thread number large than whats is currently running: '";
const char* StringsConstants::UnknownCommandMessage = "Opps, You have provided an unknown option please provide on of the following : stop , pause, resume or status \r\n"
